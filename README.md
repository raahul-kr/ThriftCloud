...
The repo now covers Phase 2 workflows and an early Phase 3 insight layer:
...
- recommendation lifecycle actions for acknowledge, dismiss, assign owner, and resolve
- dashboard metrics for active rules, triggered rules, and potential savings
- deterministic spend forecasting and provider anomaly detection on seeded billing data
- recommendation, forecast, and anomaly panels rendered in the UI
...
1. add Alembic migrations and real AWS/Azure/GCP adapters behind the seeded data layer
2. replace deterministic forecast/anomaly services with trained models when ready
3. add AI copilot endpoints with cited answers
